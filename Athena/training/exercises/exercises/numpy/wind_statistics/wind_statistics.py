...
1. The data in 'wind.data' has the following format::
   ...
   The remaining 12 columns are average wind-speeds in knots at 12
   locations in Ireland on that day.
   
   Use the 'loadtxt' function from numpy to read the data into
   an array.
      
2. Calculate the min, max and mean wind-speeds and standard deviation of the
   wind-speeds over all the locations and all the times (a single set of numbers
...
5. Find the location which has the greatest wind speed on each day (an integer column
   number for each day). 
