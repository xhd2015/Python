'''
comm_world.py -- Trivial mpi4py program that demos the most basic attributes of
MPI.COMM_WORLD.

To run this program with 4 processes, the commandline invocation is likely
something like:

    $ mpiexec -n 4 python comm_world.py
'''
...
# sleep a different amount of time before continuing.
