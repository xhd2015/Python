...
def performance_fib():
    ...
    f1= timeit.timeit( """fib(20)""",
    setup="""from ch10_ex1 import fib""", number=1000 )
    print( "Naive", f1 )

    f2= timeit.timeit( """fibc(20); fibc.cache_clear()""",
